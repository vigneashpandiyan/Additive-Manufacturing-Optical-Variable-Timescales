...
path_ = r'C:\Users\srpv\Desktop\C4Science\lpbf-optical-variable-time-scales\Dataset\Data'
r = os.listdir(path_)
...
for folder_name in r:
    ...
    for filename in sorted(all_files, key=numericalSort):
        ...
        sig = pd.read_csv(filename, delimiter=" ", skiprows=26, dtype=np.int32, names=cols)
