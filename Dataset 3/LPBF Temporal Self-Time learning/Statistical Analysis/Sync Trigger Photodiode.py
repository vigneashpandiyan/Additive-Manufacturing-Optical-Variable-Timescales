# -*- coding: utf-8 -*-
"""
Created on Mon Apr 10 18:34:14 2023
...
for filename in sorted(all_files, key=numericalSort):
    ...
    data = pd.read_csv(filename, delimiter=" ", skiprows=26, dtype=np.int32, names=cols)
...
ax1.legend(['Laser trigger'], loc='upper right', frameon=False, bbox_to_anchor=(0.42, 1.325))
