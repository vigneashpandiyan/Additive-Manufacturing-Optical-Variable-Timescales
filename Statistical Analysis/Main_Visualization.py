...
# RMS-3,  # Skewness-6,  #Kurtosis-7
data = plots(3, Featurespace, classspace, "RMS", path_)
data = plots(6, Featurespace, classspace, "Skewness",
             path_)  # RMS-3 , #Skewness-6,  #Kurtosis-7
data = plots(7, Featurespace, classspace, "Kurtosis",
             path_)  # RMS-3 , #Skewness-6,  #Kurtosis-7
