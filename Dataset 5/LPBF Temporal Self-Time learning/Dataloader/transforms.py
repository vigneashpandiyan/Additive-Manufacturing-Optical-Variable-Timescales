...
class Scaling:
    ...
    def forward(self, data):
        return scaling(data, sigma=self.sigma)
...
class WindowSlice:
    ...
    def forward(self, data):
        return window_slice(data, reduce_ratio=self.reduce_ratio)
...
class WindowWarp:
    ...
    def forward(self, data):
        return window_warp(data, window_ratio=self.window_ratio, scales=self.scales)
